...
<!--注册开始-->
    <div class="reg" >
        <form action="${pageContext.request.contextPath}/myrecruitment/saveRecruitment" method="post" name="form1" id="form1"  onsubmit = "return checkUser();" >
            <dl>
            	<dd  class="mydd"><input  type="hidden" name="id" value="${requestScope.myrecruitment.id}" id="id" onblur="checkNickName(this.value)" type="text" /></dd>
    			<!-- 岗位名称 -->
	 					...
	 					success: function(data){
	 						//alert("保存成功");
	 						 ...
	 						 if("-1" == data.code){
	 							...
	 							//表示注册成功，调到登录页面
	 							//alert("101111");
	 							parent.window.location="${pageContext.request.contextPath}/myrecruitment/recruitmentlist";
