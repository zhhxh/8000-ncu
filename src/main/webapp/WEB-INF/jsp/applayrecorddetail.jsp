      ...
      <div class="xiangqingcontain"> 
       ...
       <ul class="xiangqinglist clearfix"> 
        ...
        <%--  <p>工作地点: ${myrecruitment.address }</p>  --%>
         ...
         <p>工作职责:</p> 
         <p> ${myrecruitment.jobduty } </p>  <br /> 
 
         <p>任职要求：</p> 
         <p> ${myrecruitment.jobrequired } </p>  <br /> 
        ...
        <div class="xiangqingfooter clearfix"> 
         ...
         <a id="apply" style="cursor:pointer;${requestScope.hasDelete?'background-color:#BFBFBF':'background-color:#00B38A'}">${requestScope.hasDelete?'已经下线':'已经申请' }</a>
