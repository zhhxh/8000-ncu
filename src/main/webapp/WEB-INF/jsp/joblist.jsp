                                        ...
                                        <div class="col-md-12 col-sm-12 myCard" >
                                            <div class="serviceBox" style="padding-bottom:15px;">
                                                ...
                                                <div class="service-Content" style="overflow: hidden;">
                                                    <div id="leftJob">
                                                        <span class="title">  <a href="${pageContext.request.contextPath}/myrecruitment/detail?id=${data.id }" style="font-size:17px;" target="_blank">${data.jobname }</a>   </span>
                                                    ...
                                                    <div id="rightCompany">
                                                        <span class="title"> <a href="${pageContext.request.contextPath}/company/companyDetail?id=${data.cid }" target="_blank" style="font-size:16px;">${data.companyname }</a> </span>
                                                        <br/>
