	   ...
	   <div class="bs-module"> 
	    <div class="menu-simple "> 
	     <ul id="portalmenu"> 
	      ...
	      <li><a target="_self" href="${pageContext.request.contextPath}/myrecruitment/joblist?xiaozheng=all" ${ requestScope.xiaozheng == 'all' ? 'class="current"':'' }>职位搜索</a> </li>
	      <li><a target="_self" href="${pageContext.request.contextPath}/myrecruitment/joblist?type=校招" ${requestScope.moreCondition.type == '校招' ? 'class="current"':'' }  >实习专区</a> </li>
       ...
       <div class="zhiweisousuo bodertop selectmod" style="width:100%;margin-left: 0">
        ...
        <div class="serchcontain">
          ...
          <select class="dropdown" id="address" name="address" tableindex="12" style="" >
          		...
          		<option value="东莞" ${requestScope.moreCondition.address eq '东莞'?"selected=\"selected\"":""} >深圳</option> 
          		<option value="南京" ${requestScope.moreCondition.address eq '南京'?"selected=\"selected\"":""} >南京</option> 
          		<option value="珠海" ${requestScope.moreCondition.address eq '珠海'?"selected=\"selected\"":""} >珠海</option> 
          		
          		<!-- 成都、杭州、武汉、重庆、南京、天津、苏州、西安、长沙、沈阳、青岛、郑州、大连、东莞和宁波 -->
          		<option value="成都" ${requestScope.moreCondition.address eq '成都'?"selected=\"selected\"":""} >成都</option> 
          		<option value="杭州" ${requestScope.moreCondition.address eq '杭州'?"selected=\"selected\"":""} >杭州</option> 
          		<option value="武汉" ${requestScope.moreCondition.address eq '武汉'?"selected=\"selected\"":""} >武汉</option> 
          		<option value="重庆" ${requestScope.moreCondition.address eq '重庆'?"selected=\"selected\"":""} >重庆</option> 
          		<option value="南京" ${requestScope.moreCondition.address eq '南京'?"selected=\"selected\"":""} >南京</option> 
          		<option value="天津" ${requestScope.moreCondition.address eq '天津'?"selected=\"selected\"":""} >天津</option> 
          		<option value="苏州" ${requestScope.moreCondition.address eq '苏州'?"selected=\"selected\"":""} >苏州</option> 
          		<option value="西安" ${requestScope.moreCondition.address eq '西安'?"selected=\"selected\"":""} >西安</option> 
          		<option value="长沙" ${requestScope.moreCondition.address eq '长沙'?"selected=\"selected\"":""} >长沙</option> 
          		<option value="沈阳" ${requestScope.moreCondition.address eq '沈阳'?"selected=\"selected\"":""} >沈阳</option> 
          		<option value="青岛" ${requestScope.moreCondition.address eq '青岛'?"selected=\"selected\"":""} >青岛</option> 
          		<option value="郑州" ${requestScope.moreCondition.address eq '郑州'?"selected=\"selected\"":""} >郑州</option> 
          		<option value="大连" ${requestScope.moreCondition.address eq '大连'?"selected=\"selected\"":""} >大连</option> 
<!-- 				福建省：福州市 厦门市 泉州市 漳州市 南平市 三明市 龙岩市 莆田市 宁德市 建瓯市 武夷山市 长乐市福清市 晋江市 南安市 福安市 龙海市 邵武市 石狮市 福鼎市 建阳市 漳平市 永安市  -->
          		="成都" ${requestScope.moreCondition.address eq '成都'?"selected=\"selected\"":""} >成都</option> 
          		<option value="福州" ${requestScope.moreCondition.address eq '福州'?"selected=\"selected\"":""} >福州</option> 
          		<option value="厦门" ${requestScope.moreCondition.address eq '厦门'?"selected=\"selected\"":""} >厦门</option> 
          		<option value="泉州" ${requestScope.moreCondition.address eq '泉州'?"selected=\"selected\"":""} >泉州</option> 
          		<option value="漳州" ${requestScope.moreCondition.address eq '漳州'?"selected=\"selected\"":""} >漳州</option> 
          		<option value="南平" ${requestScope.moreCondition.address eq '南平'?"selected=\"selected\"":""} >南平</option> 
          		<option value="三明" ${requestScope.moreCondition.address eq '三明'?"selected=\"selected\"":""} >三明</option> 
          		<option value="龙岩" ${requestScope.moreCondition.address eq '龙岩'?"selected=\"selected\"":""} >龙岩</option> 
          		<option value="莆田" ${requestScope.moreCondition.address eq '莆田'?"selected=\"selected\"":""} >莆田</option> 
          		<option value="宁德" ${requestScope.moreCondition.address eq '宁德'?"selected=\"selected\"":""} >宁德</option> 
          		<option value="武夷山" ${requestScope.moreCondition.address eq '武夷山'?"selected=\"selected\"":""} >武夷山</option> 
          		<option value="龙海" ${requestScope.moreCondition.address eq '龙海'?"selected=\"selected\"":""} >龙海</option> 
          		<option value="建阳" ${requestScope.moreCondition.address eq '建阳'?"selected=\"selected\"":""} >建阳</option>
          ...
          <select class="dropdown" id="workexperience" name="workexperience" tableindex="12" style="margin-left:200px;" >
          		...
          		<option value="1-3年" ${requestScope.moreCondition.workexperience eq '1-3年'?"selected=\"selected\"":""} >1-3年</option> 
          ...
          <select class="dropdown" id="xueli" name="xueli" tableindex="12" style="margin-left:200px;" >
          		...
          		<option ${requestScope.moreCondition.xueli eq '本科'?"selected=\"selected\"":""} >本科</option> 
          		<option ${requestScope.moreCondition.xueli eq '硕士'?"selected=\"selected\"":""} >硕士</option> 
         ...
         <select class="dropdown" id="type" name="type" tableindex="12">
          ...
          <select class="dropdown" id="development" name="development" tableindex="12">
				 ...
				 <option ${requestScope.moreCondition.development eq '天使轮'?"selected=\"selected\"":""} >天使轮</option>
				 <option ${requestScope.moreCondition.development eq 'A轮'?"selected=\"selected\"":""} >A轮</option>
				 <option ${requestScope.moreCondition.development eq 'B轮'?"selected=\"selected\"":""} >B轮</option>
				 <option ${requestScope.moreCondition.development eq 'C轮'?"selected=\"selected\"":""} >C轮</option>
				 <option ${requestScope.moreCondition.development eq 'D轮'?"selected=\"selected\"":""} >D轮</option>
          ...
          <select class="dropdown" id="moneyrange" name="moneyrange" tableindex="12">
        		 ...
        		 <option value="8000"  ${requestScope.moreCondition.moneyrange eq '8000'?"selected=\"selected\"":""} >8000 - 10000</option> 
        		 <option value="10000" ${requestScope.moreCondition.moneyrange eq '10000'?"selected=\"selected\"":""} >10000 - 15000</option> 
          ...
          <select class="dropdown" id="minpeople" name="minpeople" tableindex="12">
        		 ...
        		 <option value="500" ${requestScope.moreCondition.minpeople eq '499'?"selected=\"selected\"":""}>不少于500人</option> 
                    ...
                    <div class="zhiweisousuo bodertop selectmod" style="width:100%;margin-left: 0">
                        ...
                        <div class="serchcontain">
                            <div class="d4">
                                <select class="dropdown" id="address" name="address" tableindex="12" style="">
                                    <option value="">工作城市</option>
                                    <option value="北京" ${requestScope.moreCondition.address eq '北京'?"selected=\"selected\"":""} >
                                        北京
                                    </option>
                            ...
                            <div class="d4">
                                <select class="dropdown" id="xueli" name="xueli" tableindex="12"
                                        style="margin-left:200px;">
                                    <option value="">学历要求</option>
                                    <option ${requestScope.moreCondition.xueli eq '大专'?"selected=\"selected\"":""} >大专
                                    </option>
                                    <option ${requestScope.moreCondition.xueli eq '本科'?"selected=\"selected\"":""} >本科
                                    </option>
                                    <option ${requestScope.moreCondition.xueli eq '硕士'?"selected=\"selected\"":""} >硕士
                                    </option>
                                    <option ${requestScope.moreCondition.xueli eq '博士'?"selected=\"selected\"":""} >博士
                                    </option>
                            ...
                            <div class="d4">
                                <select class="dropdown" id="type" name="type" tableindex="12">
                                    <option value="">招聘类别</option>
                                    <option ${requestScope.moreCondition.type eq '社招'?"selected=\"selected\"":""} >社招
                                    </option>
                                    <option ${requestScope.moreCondition.type eq '校招'?"selected=\"selected\"":""} >校招
                                    </option>
                            ...
                            <div class="d4">
                                <select class="dropdown" id="datenumber" name="datenumber" tableindex="12">
                                    <option value="">发布时间</option>
                                    <option value="1" ${requestScope.moreCondition.datenumber eq '1'?"selected=\"selected\"":""}>
                                        24小时内
                                    </option>
                                    <option value="3" ${requestScope.moreCondition.datenumber eq '3'?"selected=\"selected\"":""}>
                                        近三天
                                    </option>
                                    <option value="7" ${requestScope.moreCondition.datenumber eq '7'?"selected=\"selected\"":""}>
                                        近一周
                                    </option>
                                    <option value="30" ${requestScope.moreCondition.datenumber eq '30'?"selected=\"selected\"":""}>
                                        近一个月
                                    </option>
                                    <option value="1500" ${requestScope.moreCondition.datenumber eq '1500'?"selected=\"selected\"":""}>
                                        不限要求
                                    </option>
                                </select>
                            </div>
                    ...
                    $(function () {
                        $("#page").bootstrapPaginator({
                            ...
                            onPageClicked: function (event, originalEvent, type, page) {
                                ...
                                window.location.href = '${pageContext.request.contextPath}/myrecruitment/joblist?page1=' + page + "&address=" + address + "&xueli=" + xueli + "&workexperience=" + workexperience + "&type=" + type + "&development=" + development + "&moneyrange=" + moneyrange + "&minpeople=" + minpeople + "&datenumber=" + datenumber + "&datalist=" + datalist;
