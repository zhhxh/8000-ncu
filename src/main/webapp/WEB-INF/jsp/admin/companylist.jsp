                            ...
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                    <form role="form" method="get"
                                          action="${pageContext.request.contextPath}/sysadmin/companylist"
                                          class="form-inline">
                                        <div class="form-group">

                                            <label for="companyname">公司名称:</label>
                                            <input type="input" placeholder="请输入公司名称" name="companyname"
                                                   id="companyname" value="${requestScope.companyname }"
                                                   class="form-control">
                                        </div>
                                        ...
                                        <div class="form-group" style="margin-left:50px;">
                                            ...
                                            <select class="form-control" name="isallow" id="isallow">
                                                <option value="3" ${is eq 3 ? "selected=\"selected\"":"" }>--选择是否审核--
                                                </option>
                                        ...
                                        <button class="btn btn-primary" style="margin-top:10px;margin-left:50px;"
                                                onclick="zhikong()">置空
                                        </button>
                                    </form>
                                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <form role="form" class="form-horizontal" method="post" enctype="multipart/form-data"
                              action="${pageContext.request.contextPath}/sysadmin/updateCompany">
                            <input type="hidden" name="id" id="id">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">公司名称：</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" required id="companyname1"
                                           name="companyname">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control" required name="development" id="development"
                                            name="development">
                                        <option>未融资</option>
                                        <option>天使轮</option>
                                        <option>A轮</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" required id="releasednumber"
                                           name="releasednumber">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    <img src="" id="idcardimage" class="img-responsive" style="height:40px;width:40px;"
                                         alt="">
                                </div>
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-1">
                                    <img id="companyimage" class="img-responsive" style="height:40px;width:40px;"
                                         alt="">
                                </div>
                                <div class="col-sm-3">
