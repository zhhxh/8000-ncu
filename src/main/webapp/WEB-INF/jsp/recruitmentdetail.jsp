...
<body>
  ...
  <jsp:include page="../common/header.jsp" flush="true" />
   ...
   <div style=" background-color: #f9f9f9; padding-left: 40px"  >
    <input type="button"   style="background-color: #5e5e5e; width:60px; height: 50px;opacity:0.3;" onclick="getLocc(address);  " value="查看地图"/>

    <div id="allmap" style="width:80%; height: 400px; margin: 15px auto;" align="center"></div>
   </div>
   <!-- 静态包含 -->
