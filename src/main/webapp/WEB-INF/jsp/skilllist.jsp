    ...
    <div class="bs-module">
        <div class="menu-simple ">
            <ul id="portalmenu">
                ...
                <li><a target="_self"
                       href="${pageContext.request.contextPath}/myrecruitment/joblist?xiaozheng=all" ${ requestScope.all == 'all' ? 'class="current"':'' }>职位搜索</a>
                </li>
                <li><a target="_self" href="${pageContext.request.contextPath}/myrecruitment/joblist?type=校招">实习专区</a>
                </li>
                <li><a target="_self" href="${pageContext.request.contextPath}/articles/user/articlesList">最新资讯</a></li>
                <li><a target="_self" href="${pageContext.request.contextPath}/skill/showOurCompany" class="current">求职技巧</a>
                </li>
...
<div class="contain joblist clearfix">
    ...
    <div class="clearfix sousuocontain fl" style="width:100%;color: #ffffff">
        ...
        <div style="height:8px; background: #eff0f4"/>
    </div>
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="thumbnail" style="height: 230px">
                                    <a href="#" class="thumbnail">
                                        <img src="${pageContext.request.contextPath}/pic?img=${data.articleimg}"
                                             style="width:100%; height: 150px"
                                             id="aaaa">
                                    </a>
                                    <div class="caption" style="margin-top: -20px">
                                        <span class="title">  <a
                                                href="${pageContext.request.contextPath}/skill/detail?id=${data.articleid}"
                                                style="font-size:17px;"
                                                target="_blank">${data.articletitle }</a>   </span>
                                    </div>
                                </div>
                            </div>
                        </c:forEach>
