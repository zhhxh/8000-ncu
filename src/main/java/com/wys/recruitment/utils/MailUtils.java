...
public class MailUtils {
    ...
    public static final String FROM = "lixiaoming1216@163.com";//发件人的email
    public static final String PWD = "lixiaoming021388";//网易邮箱的客户端授权密码
...
/*        
    ...
    public static void main(String[] args) {
        MailUtils.send("1124002495@163.com", "当年我很喜欢你,你却只你自己");
    }
}